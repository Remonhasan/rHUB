    ...
    <div className="h-80 w-310px md:h-72 md:w-600px bg-slate-100 dark:bg-[#1f1b24] dark:hover:bg-[#121015] rounded-2xl hover:shadow-lg mt-40px md:mt-20px">
      <div className="d-flex">
        ...
        <div className="flex justify-between dark:text-white">
          <div className="flex flex-col ml-20px gap-y-2 overflow-hidden">
            <div className="text-xs font-bold tracking-normal mr-1 md:text-sm">
              {item.description.split(" ").slice(0, 28).join(" ") + "..."}
            </div>
            <div className="flex justify-between gap-x-8 mt-2 md:gap-x-0 md:justify-evenly">
              <div className="mt-10px font-bold">₹ {item.price }</div>
